  ...
  <section id='about' className='about-content flex' data-testid='about'>
    <div className='about-details-container'>
      ...
      <p className='text-content'>
          Hello there,<br/>
          I am a Front-end developer and automobile enthusiast with a love for clean concise code, an aspiring Mechanical Engineer, and a future Manchester United owner - I know, that is quite something.<br/>
          Pair programming and remote work specialist. Fluent in multiple languages, frameworks, and technologies, and capable of getting the job done efficiently with time to spare.<br/>
          I am your developer, let's get on a zoom call.<br/>
      </p>
    </div>
    <div className='about-details-container'>
      <h2>Experience</h2>
